...
class assignedSegment:
    ...
    def isContained(self, otherSegment):
        if(self.start >= otherSegment.start and self.end <= otherSegment.end):
            return True
...
for x in f:
    ...
    #print(part1.print())
    #print(part2.print())
    if(part1.isContained(part2) or part2.isContained(part1)):
        pairsContainedInOtherPairs+=1
    
print(pairsContainedInOtherPairs)
